...
# early stopping:
monitor = EarlyStopping(monitor='val_loss', min_delta=1e-7, patience=20, verbose=1, mode='auto', restore_best_weights=True)
# fit the model:
...
# save model
#model.save(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\03_FFNN','model_epochs50'))
...
#%% load model
# model = tf.keras.models.load_model(os.path.join(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\03_FFNN','model_epochs50')))
