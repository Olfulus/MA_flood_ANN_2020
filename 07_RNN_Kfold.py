# -*- coding: utf-8 -*-
"""
Created on Thu Jul  9 10:04:42 2020
...
# X_pred = X[11]
# X_pred = np.reshape(X_pred,(1,78,1))
# y_sim = y[11]
...
del array_flood_CDS, array_flood_hist_1, array_rain_CDS, array_rain_hist_1
#%%
...
# save model
    model.save(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\07_RNN',f'model{fold}_epochs_earlystop_dp02'))
