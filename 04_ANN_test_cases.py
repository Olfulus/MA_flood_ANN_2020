...
# fit the model:
history = model.fit(X, y,epochs=17, batch_size=32, verbose=1, validation_data = (X_test,y_test))#; callbacks=[monitor]
...
# save model
#model.save(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\04_FFNN','model_epochs17'))
...
#%% load model
model = tf.keras.models.load_model(os.path.join(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\04_FFNN','model_epochs17')))
...
# np.save(os.path.join(link_folder,"04_ep17_ev1.npy"),yhat1)
# np.save(os.path.join(link_folder,"04_ep17_ev2.npy"),yhat2)
# np.save(os.path.join(link_folder,"04_ep17_ev3.npy"),yhat3)
#%% for difference maps
...
np.save(os.path.join(link_folder,"04_ep17_difference_ev1.npy"),difference_1)
np.save(os.path.join(link_folder,"04_ep17_difference_ev2.npy"),difference_2)
np.save(os.path.join(link_folder,"04_ep17_difference_ev3.npy"),difference_3)
#%% confusion matrix
...
np.save(os.path.join(link_folder,"04_ep17_hit_miss_ev1.npy"),y_diff_1_map)
np.save(os.path.join(link_folder,"04_ep17_hit_miss_ev2.npy"),y_diff_2_map)
np.save(os.path.join(link_folder,"04_ep17_hit_miss_ev3.npy"),y_diff_3_map)
