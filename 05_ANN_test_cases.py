# -*- coding: utf-8 -*-
"""
Created on Fri Jul 10 13:34:02 2020
...
# event 4
X_pred_1 = X[4]
X_pred_1 = np.reshape(X_pred_1,(1,4))
y_sim_1 = y[4]
y_sim_1 = np.reshape(y_sim_1,(1,361315))
# event 11
X_pred_2 = X[11]
X_pred_2 = np.reshape(X_pred_2,(1,4))
y_sim_2 = y[11]
y_sim_2 = np.reshape(y_sim_2,(1,361315))
# event 16
X_pred_3 = X[16]
X_pred_3 = np.reshape(X_pred_3,(1,4))
y_sim_3 = y[16]
...
del X_pred_1, X_pred_2, X_pred_3, y_sim_1, y_sim_2, y_sim_3, array_flood_CDS, array_flood_hist_1, array_flood_hist_2, array_rain_CDS, array_rain_hist_1, array_rain_hist_2
#%%
...
model = Sequential()
model.add(Dense(39, activation='relu', kernel_initializer='he_normal',
...
# early stopping:
monitor = EarlyStopping(monitor='val_loss', min_delta=1e-2, patience=10, verbose=1, mode='auto', restore_best_weights=True)
# fit the model:
history = model.fit(X, y,epochs=300, batch_size=32, verbose=1, validation_data = (X_val,y_val))#; callbacks=[monitor]
...
# save model
model.save(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\05_FFNN','model_epochs300'))
...
#%% load model
model = tf.keras.models.load_model(os.path.join(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\05_FFNN','model_epochs300')))
    
#%% prediction 
X_pred1 = X_test[0].reshape(1,4)
y_sim1 = y_test[0].reshape(1,361315)

X_pred2 = X_test[1].reshape(1,4)
y_sim2 = y_test[1].reshape(1,361315)

X_pred3 = X_test[2].reshape(1,4)
...
# np.save(os.path.join(link_folder,"05_ep300_ev1.npy"),yhat1)
# np.save(os.path.join(link_folder,"05_ep300_ev2.npy"),yhat2)
# np.save(os.path.join(link_folder,"05_ep300_ev3.npy"),yhat3)
#%% for difference maps
...
np.save(os.path.join(link_folder,"05_ep300_difference_ev1.npy"),difference_1)
np.save(os.path.join(link_folder,"05_ep300_difference_ev2.npy"),difference_2)
np.save(os.path.join(link_folder,"05_ep300_difference_ev3.npy"),difference_3)
#%% confusion matrix
...
# np.save(os.path.join(link_folder,"05_ep300_hist_miss_ev1.npy"),y_diff_1_map)
# np.save(os.path.join(link_folder,"05_ep300_hist_miss_ev2.npy"),y_diff_2_map)
# np.save(os.path.join(link_folder,"05_ep300_hist_miss_ev3.npy"),y_diff_3_map)
...
fig.savefig(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\05_FFNN\05_hist_event1',dpi=300)
plt.show()