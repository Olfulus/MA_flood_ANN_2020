...
Setup 03 FFNN_raw3 - kfold
Training on CDS + 21 hist. Events; shifted / multiplied CDS events; 126  training samples
"""
...
# save model
    model.save(os.path.join(r'C:\Users\boehm\Google_Drive\Masterarbeit\Part4_ANN_versions\ANNs\Models\03_FFNN',f'model{fold}_epochs_earlystop_dp02'))
...
# scores_all_test = np.concatenate(scores_all_test)
